// /home/jesus/python/TFG/APP/frontend/src/components/__tests__/HU/mistral/HU-04-mistral.test.jsx
...
describe('HU-04: Ver tareas', () => {
    it('Al acceder a la lista de tareas, se deben mostrar todas las tareas asociadas al usuario.', async () => {
        const mockTareas = [
            ...
            { id: 2, titulo: 'Tarea 2', estado: 'en_progreso', prioridad: 'media', fecha_vencimiento: '2023-12-05' },
            { id: 3, titulo: 'Tarea 3', estado: 'completada', prioridad: 'baja', fecha_vencimiento: '2023-11-25' },
        ];
        ...
        await waitFor(() => {
            mockTareas.forEach(tarea => {
                expect(screen.getByText(tarea.titulo)).toBeInTheDocument();
            });
        });
    });

    it('Cada tarea debe estar agrupada según su estado.', async () => {
        const mockTareas = [
            { id: 1, titulo: 'Tarea 1', estado: 'pendiente', prioridad: 'alta', fecha_vencimiento: '2023-12-01' },
            { id: 2, titulo: 'Tarea 2', estado: 'en_progreso', prioridad: 'media', fecha_vencimiento: '2023-12-05' },
            { id: 3, titulo: 'Tarea 3', estado: 'completada', prioridad: 'baja', fecha_vencimiento: '2023-11-25' },
